...
public record LoginResult(string AccessToken, string RefreshToken, DateTime AccessTokenExpiresAt, DateTime RefreshTokenExpiresAt, UserDto User, bool RequiresTwoFactor = false, string? TwoFactorToken = null, string? DeviceToken = null);
